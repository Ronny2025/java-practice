...
public class Replit42VehicleRecall {
public static void main(String[] args) {
Scanner scan = new Scanner(System.in);
	int vehicleYear;
	System.out.println("Ente vehicle's year:");
	vehicleYear = scan.nextInt();
if(vehicleYear>= 1995 && vehicleYear <=1998 ) {System.out.println("your vehicle needs to be recalled");


}else if(vehicleYear>= 2001 && vehicleYear <=2002 ) {System.out.println("your vehicle needs to be recalled");
