...
public static void main(String[] args) {
	...
	//print how many rows/teams/array
	
	
	System.out.println("Numbers of rows:" + teams.length);
	System.out.println("People of in the first team:" + teams[0].length);
	...
	int[][]scores= {{3,5,10} , {4,4,2,10}};
			...
			values[1]=new int [] {34,35,6,5,34,2,2,43,45,56,567,3};
