...
public class calculator {
	...
	/*
	 * 1) method addVoid return type: void params: int num1, int num2 add them and
	 * print sum
	 */
	...
	/*
	 * 2) method name: add return type: int params: int num1, int num2 add them and
	 * return the sum
	 */
	...
	/*
	 * Method: multiply with return value Method: minus with return value Method:
